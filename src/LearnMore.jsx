      ...
      <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div className={`bg-gradient-to-r ${topic.color} p-6`}>
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-white">{topic.category}</h3>
                </div>
              </div>
                ...
                <ul className="space-y-3">
                  {topic.topics.map((item, itemIndex) => (
                    <li key={itemIndex} className="flex items-center space-x-3">
                      <div className="w-2 h-2 bg-[#65b25f] rounded-full flex-shrink-0"></div>
                      <span className="text-gray-700">{item}</span>
                    </li>
                  ))}
                </ul>
                
                <button className={`mt-6 w-full bg-gradient-to-r ${topic.color} hover:opacity-90 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 transform hover:scale-105`}>
        ...
        <div className="bg-gradient-to-r from-[#075b95]/10 to-[#65b25f]/10 rounded-3xl p-8 md:p-12 text-center">
          <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
            Ready to Become a Sri Lanka Expert?
          </h3>
