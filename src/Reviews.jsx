...
const Reviews = () => {
  ...
  return (
    <section id="reviews" className="py-20 px-6 bg-gradient-to-br from-[#075b95]/5 via-white to-[#65b25f]/5">
          ...
          {reviews.map((review, index) => (
            <div key={index} className="group">
              <div className="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 p-8 border border-gray-100 transform hover:-translate-y-2">
                {/* Quote Icon */}
                <div className="mb-6">
                  <svg className="w-8 h-8 text-[#075b95]/20" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <div className="flex items-center mt-1">
                      {[...Array(review.rating)].map((_, i) => (
                        <svg key={i} className="w-4 h-4 text-[#65b25f] fill-current" viewBox="0 0 24 24">
