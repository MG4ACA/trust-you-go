...
export const locationMapper = {
  ...
  toRedux: (apiLocation) => {
    ...
    return {
      ...
      latitude: apiLocation.latitude !== null && apiLocation.latitude !== undefined ? Number(apiLocation.latitude) : null,
      longitude: apiLocation.longitude !== null && apiLocation.longitude !== undefined ? Number(apiLocation.longitude) : null,
  ...
  toAPI: (reduxLocation) => {
    ...
    return {
      ...
      latitude: reduxLocation.latitude !== undefined && reduxLocation.latitude !== '' ? reduxLocation.latitude : null,
      longitude: reduxLocation.longitude !== undefined && reduxLocation.longitude !== '' ? reduxLocation.longitude : null,
